...
const mainNavItems: NavItem[] = [
    ...
    {
        title: 'Community',
        href: DiscoverController.community(),
        icon: LayoutGrid,
    },
];
...
<template>
    <div>
        <div class="border-b border-sidebar-border/80 bg-card bg-text-foreground">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-6xl">
                ...
                <div class="ml-auto flex items-center space-x-2">
                        ...
                        <TooltipProvider>
                            <Tooltip>
                                <TooltipTrigger as-child>
                                    <Button variant="ghost" size="icon" class="group h-9 w-9 cursor-pointer" as-child>
                                        <Link :href="DiscoverController.explore()">
                    ...
                    <Button size="sm" v-if="!auth.user" variant="link">
