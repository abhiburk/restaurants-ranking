...
<template>
    ...
    <AppLayout>
        <section class="fade-3 flex flex-col gap-6">
            <div>
            ...
            <!-- Search -->
            <div>
                <SearchInput :options="{only: ['comingSoonCities']}" :route="CityController.comingSoonCities().url" v-model="filters.search" class="w-full text-sm outline-none " placeholder="Search cities" />
            </div>
            ...
            <div class="grid grid-cols-1 gap-3">
                <Deferred :data="['comingSoonCities']">
                    ...
                    <CityBanner :city="city" v-for="city in comingSoonCities" :key="city.id" :href="RestaurantController.index(city.slug)" />
