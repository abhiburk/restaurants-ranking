...
class RestaurantFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            'name' => $name,
            'slug' => $slug,
            // 'user_id' => User::where('role', UserType::PARTNER)->inRandomOrder()->first()->id,
            ...
            'is_active' => $this->faker->randomElement([RestaurantStatus::ACTIVE, RestaurantStatus::INACTIVE]),
    ...
    /**
     * Indicate that the restaurant is active.
     */
