...
namespace App\Filament\Contributor\Resources\RestaurantSubmissions\Schemas;
                                        ...
                                        ->schema([
                                            ...
                                            Select::make('city_id')
                                                ...
                                                ->relationship('city', 'name', function (Builder $query) { 
                                                    return $query->active()->whereHas('contributors', function (Builder $query) {
                                                        $query->active()->where('user_id', auth()->id());
                                                    });
                                                }),
