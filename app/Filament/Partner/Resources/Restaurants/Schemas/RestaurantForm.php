                                ...
                                ->schema([
                                    ...
                                    Actions::make([
                                        Action::make('generateQR')
                                            ...
                                            ->hidden(fn ($record) => $record?->qr_code),
                                        Action::make('downloadQR')
                                            ->label('Download QR')
                                            ->icon('heroicon-o-arrow-down-tray')
                                            ->url(fn ($record) => route('restaurants.qr.download', $record))
                                            ->openUrlInNewTab()
                                            ->hidden(fn ($record) => ! $record?->qr_code),
                                    ]),
                                ]),
                            ...
                            Section::make('Settings')
                                ...
                                ->schema([
                                    ...
                                    Toggle::make('is_active')
                                        ->label('Active')
                                        ->columnSpanFull()
                                        ->helperText('Whether the restaurant is currently active and visible to customers'),
                                ]),
